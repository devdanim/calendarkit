...
import { ChevronDown, Globe, Menu, CalendarCheck, ChevronLeft, ChevronRight, SlidersHorizontal, Sun, Moon, CalendarDays, CalendarRange, Calendar, ListTodo, Clock, Users, Paperclip, Bell, Edit3, Copy, Trash2 } from 'lucide-react';
...
var CalendarHeader = ({
  ...
  return /* @__PURE__ */ React12__default.createElement(
    ...
    /* @__PURE__ */ React12__default.createElement("div", { className: "flex w-full items-center justify-between gap-2 md:w-auto md:justify-start" }, /* @__PURE__ */ React12__default.createElement("div", { className: "flex items-center gap-2 md:gap-3" }, isWide && onMenuClick && /* @__PURE__ */ React12__default.createElement(
      Button,
      {
        variant: "ghost",
        size: "icon",
      ...
      /* @__PURE__ */ React12__default.createElement(SlidersHorizontal, { className: "h-5 w-5" })
    )),
  ...
  return /* @__PURE__ */ React12__default.createElement(
    ...
    /* @__PURE__ */ React12__default.createElement("div", { className: cn("flex-1 space-y-4 px-4", showMiniCalendar ? "mt-5" : "mt-0") }, showCalendarFilters && filterSections.map((section) => {
      ...
      return /* @__PURE__ */ React12__default.createElement(
        ...
        section.title && /* @__PURE__ */ React12__default.createElement(
          "div",
          {
            ...
            /* @__PURE__ */ React12__default.createElement(
              "path",
              {
                ...
                d: "M5 13l4 4L19 7"
                        ...
                        `)),
          /* @__PURE__ */ React12__default.createElement("div", { className: "flex min-w-0 flex-1 items-center gap-2" }, item?.icon, /* @__PURE__ */ React12__default.createElement("span", { className: "break-words text-sm font-medium text-foreground/90" }, item.label))
        )))
      );
    })),
...
var MonthView = ({
  ...
  return /* @__PURE__ */ React12__default.createElement("div", { className: "scrollbar-hide flex h-full min-w-[800px] flex-col overflow-hidden rounded-2xl border-[0.5px] border-border/50 bg-[#F9F9FB] shadow-sm" }, /* @__PURE__ */ React12__default.createElement("div", { className: "relative flex-1 overflow-x-auto overflow-y-auto" }, /* @__PURE__ */ React12__default.createElement("div", { className: "sticky top-0 z-20 grid grid-cols-7 border-b-[0.5px] border-border/50 bg-gradient-to-r from-muted/30 via-muted/40 to-muted/30 backdrop-blur-sm" }, weekDays.map((day) => /* @__PURE__ */ React12__default.createElement(
    "div",
    {
      key: day.toISOString(),
    ...
    return /* @__PURE__ */ React12__default.createElement(
      ...
      /* @__PURE__ */ React12__default.createElement("div", { className: "scrollbar-hide flex flex-1 flex-col gap-1 overflow-x-auto overflow-y-auto" }, dayEvents.slice(0, 4).map((event) => /* @__PURE__ */ React12__default.createElement(
        EventItem,
        {
          key: `${event.id}-${dayKey}`,
          event,
      ...
      )), dayEvents.length > 4 && /* @__PURE__ */ React12__default.createElement("div", { className: "cursor-pointer rounded-md bg-primary/5 px-2 py-1 text-center text-[10px] font-semibold text-primary transition-colors hover:bg-primary/10" }, "+", dayEvents.length - 4, " ", translations?.more ?? "more"))
    );
  }))));
};
var WeekView = ({
  ...
  return /* @__PURE__ */ React12__default.createElement("div", { className: "flex h-full min-w-[800px] flex-col overflow-hidden rounded-2xl border-[0.5px] border-border/50 bg-background shadow-sm" }, /* @__PURE__ */ React12__default.createElement(
    "div",
    {
      ...
      /* @__PURE__ */ React12__default.createElement(
        "div",
        {
          className: cn(
            ...
            isToday(day) ? "scale-110 bg-primary text-white shadow-lg shadow-primary/30" : "text-foreground hover:bg-accent/80"
          )
        },
        format(day, "d", { locale })
      )
    ...
    /* @__PURE__ */ React12__default.createElement(
      ...
      /* @__PURE__ */ React12__default.createElement("span", { className: "-translate-y-1/2 rounded-md bg-primary px-1.5 py-0.5 text-[10px] font-bold text-white shadow-md backdrop-blur-none" }, format(zonedNow, nowFormat, { locale }))
    )
  ));
};
var DayView = ({
  ...
  return /* @__PURE__ */ React12__default.createElement("div", { className: "flex h-full flex-col overflow-hidden rounded-2xl border-[0.5px] border-border/50 bg-[#14141705] shadow-sm" }, /* @__PURE__ */ React12__default.createElement("div", { className: "shrink-0 border-b-[0.5px] border-border/50 bg-[#14141705] px-6 py-4 text-center" }, /* @__PURE__ */ React12__default.createElement("div", { className: "flex items-center justify-center gap-3" }, /* @__PURE__ */ React12__default.createElement("h2", { className: "text-xl font-semibold capitalize text-foreground" }, format(currentDate, "EEEE, MMMM d, yyyy", { locale })), isToday(currentDate) && /* @__PURE__ */ React12__default.createElement("span", { className: "rounded-full bg-primary px-3 py-1 text-xs font-semibold text-white shadow-md" }, translations?.today || "Today"))), /* @__PURE__ */ React12__default.createElement("div", { ref: scrollContainerRef, className: "relative flex-1 overflow-y-auto bg-[#14141705]" }, /* @__PURE__ */ React12__default.createElement("div", { className: "relative flex", style: { height: hours.length * hourHeight } }, /* @__PURE__ */ React12__default.createElement("div", { className: "relative w-20 border-r-[0.5px] border-border/30 bg-[#14141705]" }, hours.map((hour) => /* @__PURE__ */ React12__default.createElement("div", { key: hour, className: "relative w-full", style: { height: hourHeight } }, hour !== 0 && /* @__PURE__ */ React12__default.createElement("span", { className: "absolute -top-3 left-1/2 w-full -translate-x-1/2 rounded-md px-1.5 py-0.5 text-center text-[11px] font-medium tabular-nums text-muted-foreground/80" }, format((/* @__PURE__ */ new Date()).setHours(hour, 0, 0, 0), timeFormat, { locale })))), isToday(currentDate) && /* @__PURE__ */ React12__default.createElement(
    ...
    /* @__PURE__ */ React12__default.createElement("span", { className: "-translate-y-1/2 rounded-lg bg-primary px-2 py-1 text-[10px] font-bold text-white shadow-md" }, format(zonedNow, nowFormat, { locale }))
    ...
    return /* @__PURE__ */ React12__default.createElement(
      ...
      /* @__PURE__ */ React12__default.createElement(
        ...
        /* @__PURE__ */ React12__default.createElement("div", { className: "flex h-full w-full flex-col justify-center overflow-hidden" }, /* @__PURE__ */ React12__default.createElement(
          ...
          event.title
        ), !isShortEvent && /* @__PURE__ */ React12__default.createElement(React12__default.Fragment, null, /* @__PURE__ */ React12__default.createElement("div", { className: "text-xs font-medium leading-snug text-muted-foreground" }, format(zonedStart, eventTimeFormat, { locale })), event.description && height > 60 && /* @__PURE__ */ React12__default.createElement("div", { className: "mt-1 line-clamp-2 text-xs leading-snug text-muted-foreground/80" }, event.description)), count > 1 && !isShortEvent && /* @__PURE__ */ React12__default.createElement("div", { className: "absolute right-1.5 top-1.5 flex h-5 w-5 items-center justify-center rounded-full border border-border bg-background/90 text-[10px] font-bold text-muted-foreground shadow-sm backdrop-blur-sm" }, count))
      )
    );
...
var AgendaView = ({
  ...
  return /* @__PURE__ */ React12__default.createElement("div", { className: "flex h-full min-w-0 flex-col overflow-y-auto overflow-x-hidden bg-[#F9F9FB]" }, /* @__PURE__ */ React12__default.createElement(
    motion.div,
    {
    ...
    groupedEvents.map((group) => /* @__PURE__ */ React12__default.createElement(motion.div, { key: group.date.toISOString(), className: "relative", variants: item }, /* @__PURE__ */ React12__default.createElement("div", { className: "sticky top-0 z-10 min-w-0 border-b border-border/50 bg-[#F9F9FB] py-4 backdrop-blur-md" }, /* @__PURE__ */ React12__default.createElement("div", { className: "flex min-w-0 flex-nowrap items-center gap-2 sm:gap-4" }, /* @__PURE__ */ React12__default.createElement(
      "div",
      {
        className: cn(
          ...
          isToday(group.date) ? "bg-primary text-white shadow-lg" : "bg-muted/50 text-foreground"
        ),
        style: (
      ...
      /* @__PURE__ */ React12__default.createElement("span", { className: "truncate text-center text-2xl font-bold leading-none" }, format(group.date, "d", { locale })),
      /* @__PURE__ */ React12__default.createElement("span", { className: "truncate text-center text-xs font-medium uppercase tracking-wide opacity-80" }, format(group.date, "MMM", { locale }))
    ), /* @__PURE__ */ React12__default.createElement("div", { className: "min-w-0 flex-1 overflow-hidden" }, /* @__PURE__ */ React12__default.createElement(
      "span",
      {
        className: cn(
    ...
    ), /* @__PURE__ */ React12__default.createElement("span", { className: "block truncate text-xs text-muted-foreground sm:text-sm" }, getEventCountLabel(group.events.length))))), /* @__PURE__ */ React12__default.createElement("div", { className: "space-y-3 py-4" }, group.events.map((event) => /* @__PURE__ */ React12__default.createElement(
      "div",
      {
        key: event.id,
        onClick: () => {
      ...
      /* @__PURE__ */ React12__default.createElement("div", { className: "min-w-0 flex-1 space-y-2 overflow-hidden" }, /* @__PURE__ */ React12__default.createElement("div", { className: "flex min-w-0 items-start justify-between gap-2" }, /* @__PURE__ */ React12__default.createElement("h4", { className: "min-w-0 flex-1 truncate text-sm font-semibold text-foreground sm:text-base" }, event.title), /* @__PURE__ */ React12__default.createElement(
        "div",
        {
          className: "mt-1.5 h-3 w-3 shrink-0 rounded-full",
          style: { backgroundColor: event.color || "var(--primary)" }
        }
      )), event.description && /* @__PURE__ */ React12__default.createElement("div", { className: "line-clamp-2 text-sm leading-relaxed text-muted-foreground" }, event.description), /* @__PURE__ */ React12__default.createElement("div", { className: "flex min-w-0 flex-wrap items-center gap-2 pt-1 sm:gap-3" }, !event.allDay && /* @__PURE__ */ React12__default.createElement("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground" }, /* @__PURE__ */ React12__default.createElement(Clock, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ React12__default.createElement("span", null, format(event.start, locale?.code === "fr" ? "H:mm" : "h:mm a", {
        locale
...
var Scheduler = ({
  ...
  return /* @__PURE__ */ React12__default.createElement(
    ...
    /* @__PURE__ */ React12__default.createElement(
      ...
      sidebarEnabled && !isCompactLayout && /* @__PURE__ */ React12__default.createElement("div", { className: "flex w-64 flex-shrink-0 px-4 py-4" }, /* @__PURE__ */ React12__default.createElement(
        Sidebar,
        {
          currentDate,
      ...
      sidebarEnabled && isCompactLayout && /* @__PURE__ */ React12__default.createElement("div", { className: "fixed inset-0 z-50 h-dvh w-screen" }, /* @__PURE__ */ React12__default.createElement(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ React12__default.createElement("div", { className: "flex flex-1 flex-col overflow-hidden" }, /* @__PURE__ */ React12__default.createElement(
        CalendarHeader,
        {
          ...
          view,
          onViewChange: handleViewChange,
          onMenuClick: sidebarFeatureEnabled ? handleSidebarToggle : void 0,
          isDarkMode,
          onThemeToggle,
          translations: t,
          hideViewSwitcher,
      ...
      /* @__PURE__ */ React12__default.createElement(DragOverlay, { dropAnimation: null }, activeDragEvent ? (() => {
