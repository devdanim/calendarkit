    ...
    return /* @__PURE__ */ React12__namespace.default.createElement(
      DroppableCell,
      {
        ...
        className: cn(
          ...
          dateFns.isToday(day) && "bg-[#141417]/5 ring-1 ring-inset ring-[#141417]/20"
        ),
      ...
      /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "flex items-start justify-between" }, /* @__PURE__ */ React12__namespace.default.createElement(
        "div",
        {
          className: cn(
            ...
            dateFns.isToday(day) && "bg-[#141417] text-white shadow-md shadow-[#141417]/30"
          )
        },
        dateFns.format(day, "d", { locale })
      ...
      )), dayEvents.length > 4 && /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "cursor-pointer rounded-md bg-[#141417]/5 px-2 py-1 text-center text-[10px] font-semibold text-[#141417] transition-colors hover:bg-[#141417]/10" }, "+", dayEvents.length - 4, " more"))
    );
  }))));
};
var WeekView = ({
      ...
      /* @__PURE__ */ React12__namespace.default.createElement(
        "div",
        {
          className: cn(
            ...
            dateFns.isToday(day) ? "scale-110 bg-[#141417] text-white shadow-lg shadow-[#141417]/30" : "text-foreground hover:bg-accent/80"
          )
        },
        dateFns.format(day, "d", { locale })
      )
    ...
    /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "relative flex min-w-full", style: { height: hours.length * hourHeight } }, /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "relative w-16 flex-none border-r-[0.5px] border-border/30 bg-[#14141705]" }, hours.map((hour) => /* @__PURE__ */ React12__namespace.default.createElement(
      ...
      return /* @__PURE__ */ React12__namespace.default.createElement(
        ...
        dateFns.isToday(day) && /* @__PURE__ */ React12__namespace.default.createElement(
          ...
          /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "h-[2px] w-full bg-gradient-to-r from-[#141417] via-[#141417] to-[#141417]/50" }),
          /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "absolute -left-1.5 h-3 w-3 animate-pulse rounded-full bg-[#141417] shadow-lg shadow-[#141417]/40 ring-2 ring-background" })
        )
      );
    }))),
    /* @__PURE__ */ React12__namespace.default.createElement(
      ...
      /* @__PURE__ */ React12__namespace.default.createElement("span", { className: "-translate-y-1/2 rounded-md bg-[#141417] px-1.5 py-0.5 text-[10px] font-bold text-white shadow-md backdrop-blur-none" }, dateFns.format(zonedNow, nowFormat, { locale }))
    )
  ));
};
var DayView = ({
  ...
  return /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "flex h-full flex-col overflow-hidden rounded-2xl border-[0.5px] border-border/50 bg-[#14141705] shadow-sm" }, /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "shrink-0 border-b-[0.5px] border-border/50 bg-[#14141705] px-6 py-4 text-center" }, /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "flex items-center justify-center gap-3" }, /* @__PURE__ */ React12__namespace.default.createElement("h2", { className: "text-xl font-semibold capitalize text-foreground" }, dateFns.format(currentDate, "EEEE, MMMM d, yyyy", { locale })), dateFns.isToday(currentDate) && /* @__PURE__ */ React12__namespace.default.createElement("span", { className: "rounded-full bg-[#141417] px-3 py-1 text-xs font-semibold text-white shadow-md" }, translations?.today || "Today"))), /* @__PURE__ */ React12__namespace.default.createElement("div", { ref: scrollContainerRef, className: "relative flex-1 overflow-y-auto bg-[#14141705]" }, /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "relative flex", style: { height: hours.length * hourHeight } }, /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "relative w-20 border-r-[0.5px] border-border/30 bg-[#14141705]" }, hours.map((hour) => /* @__PURE__ */ React12__namespace.default.createElement("div", { key: hour, className: "relative w-full", style: { height: hourHeight } }, hour !== 0 && /* @__PURE__ */ React12__namespace.default.createElement("span", { className: "absolute -top-3 left-1/2 w-full -translate-x-1/2 rounded-md px-1.5 py-0.5 text-center text-[11px] font-medium tabular-nums text-muted-foreground/80" }, dateFns.format((/* @__PURE__ */ new Date()).setHours(hour, 0, 0, 0), timeFormat, { locale })))), dateFns.isToday(currentDate) && /* @__PURE__ */ React12__namespace.default.createElement(
    ...
    /* @__PURE__ */ React12__namespace.default.createElement("span", { className: "-translate-y-1/2 rounded-lg bg-[#141417] px-2 py-1 text-[10px] font-bold text-white shadow-md" }, dateFns.format(zonedNow, nowFormat, { locale }))
    ...
    groupedEvents.map((group) => /* @__PURE__ */ React12__namespace.default.createElement(framerMotion.motion.div, { key: group.date.toISOString(), className: "relative", variants: item }, /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "sticky top-0 z-10 border-b border-border/50 bg-[#F9F9FB] py-4 backdrop-blur-md" }, /* @__PURE__ */ React12__namespace.default.createElement("div", { className: "flex items-center gap-4" }, /* @__PURE__ */ React12__namespace.default.createElement(
      "div",
      {
        className: cn(
          ...
          dateFns.isToday(group.date) ? "bg-[#141417] text-white shadow-lg" : "bg-muted/50 text-foreground"
        )
      },
